...
public class RenYiHsdyjurnStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static RenYiHsdyjurnStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static RenYiHsdyjurnStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        RenYiHsdyjurnStatusBarView renYiHsdyjurnStatusBarView = new RenYiHsdyjurnStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        renYiHsdyjurnStatusBarView.setLayoutParams(params);
        renYiHsdyjurnStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        renYiHsdyjurnStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return renYiHsdyjurnStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static RenYiHsdyjurnStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        RenYiHsdyjurnStatusBarView renYiHsdyjurnStatusBarView = new RenYiHsdyjurnStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        renYiHsdyjurnStatusBarView.setLayoutParams(params);
        renYiHsdyjurnStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        renYiHsdyjurnStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return renYiHsdyjurnStatusBarView;
    }

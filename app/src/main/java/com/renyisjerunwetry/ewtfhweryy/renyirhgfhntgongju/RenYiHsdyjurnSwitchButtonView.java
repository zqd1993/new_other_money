...
public class RenYiHsdyjurnSwitchButtonView extends View {
    ...
    public RenYiHsdyjurnSwitchButtonView(Context context) {
        super(context);
    }

    public RenYiHsdyjurnSwitchButtonView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);

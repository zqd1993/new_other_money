...
import com.renyisjerunwetry.ewtfhweryy.renyirhgfhntgongju.DownRenYiHsdyjurnUtil;
...
public class RenYiHsdyjurnShowGoodsActivity extends RxAppCompatActivity implements EasyPermissions.PermissionCallbacks{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agreement_ren_yi_dai_erjr_ryntu);
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(RenYiHsdyjurnShowGoodsActivity.this);
        ...
        DownRenYiHsdyjurnUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownRenYiHsdyjurnUtil.OnDownloadListener() {
            @Override

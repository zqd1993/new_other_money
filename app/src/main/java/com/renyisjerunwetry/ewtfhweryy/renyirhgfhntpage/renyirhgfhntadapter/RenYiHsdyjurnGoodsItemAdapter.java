...
public class RenYiHsdyjurnGoodsItemAdapter extends RecyclerView.Adapter<RenYiHsdyjurnGoodsItemAdapter.GoodsItemHolder> {
    ...
    public RenYiHsdyjurnGoodsItemAdapter(Context context, List<RenYiHsdyjurnGoodsEntity> mList) {
    ...
    public GoodsItemHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.adapter_goods_item_ren_yi_dai_erjr_ryntu, parent, false);
        return new GoodsItemHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RenYiHsdyjurnGoodsItemAdapter.GoodsItemHolder holder, int position) {
